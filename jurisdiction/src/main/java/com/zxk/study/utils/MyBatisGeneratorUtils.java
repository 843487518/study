...
//    static String MySQLUrl = "jdbc:mysql://localhost:3306/chat?useSSL=false&serverTimezone=Asia/Shanghai&characterEncoding=UTF-8&allowMultiQueries=true";
    static String MySQLUrl = "jdbc:mysql://localhost:3306/utilsdemo?useSSL=false&serverTimezone=Asia/Shanghai&characterEncoding=UTF-8&allowMultiQueries=true";
